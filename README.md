...
```sh
git clone https://github.com/FAIRmat-NFDI/nomad-simulation-parsers.git
cd nomad-simulation-parsers
...
nomad-simulation-parsers==x.y.z
```
...
```sh
pip install dist/nomad-simulation-parsers-0.1.0
```
